...
class InsertAccount(private val accountRepositoryImpl: AccountRepositoryImpl) {
    suspend operator fun invoke(account: Account) = accountRepositoryImpl.addAccount(account)
}